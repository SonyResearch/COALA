...
from coala.registry import mock_etcd
from coala.registry.vclient import VirtualClient
...
class EtcdClient(object):
    ...
    def get_clients(self, prefix):
        ...
        Args:
            prefix (str): the prefix of clients addresses; default is the docker image name "coala-client"
