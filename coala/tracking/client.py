from coala.tracking.metric import TaskMetric, RoundMetric, ClientMetric
from coala.tracking.storage import get_store
...
"""coala.tracking.TrackingClient: The global tracking client object"""
