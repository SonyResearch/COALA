...
from coala.datasets.utils.remove_users import remove
from coala.datasets.utils.sample import sample, extreme
from coala.datasets.utils.split_data import split_train_test
