...
from coala.datasets.cifar100.cifar100 import Cifar100
from coala.datasets.cifar10.preprocess import transform_train_cifar, transform_test_cifar, map_new_class_index

logger = logging.getLogger(__name__)


class Cifar100Continual(Cifar100):
    """
        class-continual data stream split of CIFAR-100 for federated continual learning
    """
    ...
    def __init__(self,
                 ...
                 increment=0,
                 shuffle=False):
        super(Cifar100Continual, self).__init__(root,
                                                fraction,
                                                split_type,
                                                user,
    ...
    def preprocess(self):
        ...
        logger.info("Start CIFAR100 incremental data simulation")
        ...
        logger.info("Complete CIFAR100 class-continual data stream simulation")
...
def construct_cifar100_continual_datasets(root,
                                          dataset_name,
                                          num_of_clients,
                                          split_type,
                                          min_size=10,
    ...
    if not os.path.exists(split_data_dir):
        dataset = Cifar100Continual(root=data_dir,
