...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        assert conf is not None, "you should pass configuration to resnet"
        if 'cifar' in conf.data.dataset:
        ...
        elif 'imagenet' in conf.data.dataset:
            if conf.init_cls == conf.increment:
