...
class Cifar10SelfSupervised(BaseDataset):
    def __init__(self,
                 root,
                 fraction,
                 split_type,
                 ...
                 weights=None,
                 alpha=0.5):
        super(Cifar10SelfSupervised, self).__init__(root,
                                      CIFAR10,
                                      fraction,
                                      split_type,
                                      user,
    ...
    def download_raw_file_and_extract(self):
        ...
        train_set = CIFAR10Pair(root=self.base_folder, train=True, download=True)
...
def construct_cifar10_selfsupervised_datasets(root,
                               dataset_name,
                               num_of_clients,
                               split_type,
                               min_size,
    ...
    if not os.path.exists(split_data_dir):
        dataset = Cifar10SelfSupervised(root=data_dir,
